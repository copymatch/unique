...
SECRET_KEY = 'django-insecure-mfdsnld+wozsqxa=i$92m)^h7h2l+^w1x)hsqsfz5pr4^6l!x^'
...
INSTALLED_APPS = [
    'copywriter.apps.CopywriterConfig',
...
SESSION_EXPIRE_AT_BROWSER_CLOSE = False  # User remains logged in after closing browser
...
#"C:\Users\manuj\Downloads\copymatch.pem"